...
public class CatProdsActivity extends AppCompatActivity {
    ...
    private List<Productos> prodsEnconList;
    ...
    public void consProdsFav() {
        ...
        call.enqueue(new Callback<List<ProdsFavs>>() {
            ...
            public void onFailure(Call<List<ProdsFavs>> call, Throwable t) {
                Snackbar snackbar = Snackbar.make(CatProdsActivity.this.findViewById(android.R.id.content), "Error de conexión con el servidor", Snackbar.LENGTH_LONG)
                        .setAction("Action", null);
                View sbView = snackbar.getView();
                sbView.setBackgroundColor(ContextCompat.getColor(CatProdsActivity.this, R.color.mensajeinfo));
                snackbar.show();
